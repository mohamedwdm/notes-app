        ...
        children: [
          ...
          ListTile(
            ...
            subtitle: Padding(
              ...
              child: Text('Learn flutter with me' , style: TextStyle(color: Colors.black.withValues(alpha: 0.5) , fontSize: 20),),
            ),
            trailing: IconButton(onPressed: (){}, icon: Icon(Icons.delete , size: 24,) , color: Colors.black,),
          ),
          Padding(
            padding: const EdgeInsets.only(right: 24.0),
            child: Text('Aug , 2025' , style: TextStyle(color: Colors.black.withValues(alpha: 0.5) , fontSize: 16), ),
          ),
        ],
      ),
    );
